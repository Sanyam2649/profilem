...
const Bio = ({ Bio }) => {
  ...
  const displayText = isLongText && !isExpanded ? Bio.substring(0, 300) + '...' : Bio

  return (
    <div className="flex flex-col md:flex-row w-full min-h-screen items-center justify-center text-white px-4 md:px-8">
